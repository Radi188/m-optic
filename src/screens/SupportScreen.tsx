  ...
  const supportOptions: SupportOption[] = [
    {
      ...
      icon: 'call-outline',
      onPress: () => Linking.openURL('tel:+85595289829'),
    },
    {
      id: 'telegram',
      titleKey: 'Telegram',
      ...
      onPress: () => Linking.openURL('https://t.me/cross_technology_cambodia'),
    },
    {
      id: 'email',
      ...
      icon: 'mail-outline',
      onPress: () => Linking.openURL('mailto:info@crosscambodia.com'),
    },
    {
      id: 'location',

...
const REPORT_DATA = {
  Today: {
    ...
    orders: 8,
    customers: 6,
    topFrame: 'Classic Round',
  },
  Week: {
    revenue: '$8,530',
    orders: 54,
    customers: 41,
    topFrame: 'Aviator Pro',
  },
  Month: {
    revenue: '$32,100',
    orders: 210,
    customers: 162,
    topFrame: 'Wayfarer Plus',
  },
  Year: {
    revenue: '$384,200',
    orders: 2480,
    customers: 1840,
    topFrame: 'Cat-Eye Chic',
  },
};
      ...
      <SafeAreaView style={styles.safe}>
        <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <Card style={styles.revenueCard}>
            ...
            <AppText style={styles.revenueValue}>{data.revenue}</AppText>
            <Badge
          ...
          <Card style={styles.topFrameCard}>
            <AppText style={styles.topFrameLabel}>Top Selling Frame</AppText>
            <View style={styles.topFrameRow}>
              <GlassView
                intensity="light"
                borderRadius={BorderRadius.md}
                style={styles.topFrameIcon}
                shadow={false}
              >
                <Ionicons
              ...
              <AppText style={styles.topFrameName}>{data.topFrame}</AppText>
            </View>
          </Card>
            ...
            <Card key={sale.id} style={styles.saleCard}>
              <View style={styles.saleRow}>
                ...
                <View style={styles.saleInfo}>
                  <AppText style={styles.saleId}>{sale.id}</AppText>
                  <AppText style={styles.saleCustomer}>{sale.customer}</AppText>
                  <AppText style={styles.saleFrame}>{sale.frame}</AppText>
                </View>
                <View style={styles.saleRight}>
                  <AppText style={styles.saleAmount}>{sale.amount}</AppText>
                  <Badge
                    label={sale.status}
